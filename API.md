...
Multi-octet fields use network byte order (big-endian). Architecture: [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md). Compliance: [docs/COMPLIANCE.md](docs/COMPLIANCE.md). Frozen service contract: [docs/TP0_API_DESIGN.md](docs/TP0_API_DESIGN.md).
...
Reviewed via `go doc -all github.com/otfabric/go-cotp` against [docs/TP0_API_DESIGN.md](docs/TP0_API_DESIGN.md):
