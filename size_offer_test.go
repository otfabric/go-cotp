...
func TestBuildSizeOffer_Cases(t *testing.T) {
	...
	t.Run("case_1_configured_0_preferred_maximum", func(t *testing.T) {
		...
		// fallbackStandard(65408) now returns 0x0E (16384) since the table was
		// extended to include 0x0C–0x0E for RFC 1006 interoperability.
	...
	t.Run("case_7_maximum_65531", func(t *testing.T) {
		...
		// fallbackStandard(65408) now returns 0x0E (16384); see case_1 comment.
		if b.StandardCode == nil || *b.StandardCode != 0x0E {
...
func TestDecodeSizeOffer_DualPreserve(t *testing.T) {
	...
	t.Run("undefined_code_0x0F", func(t *testing.T) {
		c := uint8(0x0F)
